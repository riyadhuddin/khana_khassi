...
List<Product> prouductsList = [
  ...
  Product(name: "Meatball Ravoli",price: 5.1,rating: 4.2,vendor: "Pasta",wishList: false,image: "photo/2015/09/30/06/26/meatball-ravioli-964959_1280.jpg"),
  Product(name: "Ravoli",price: 5.9,rating: 4.5,vendor: "Indian",wishList: false,image: "photo/2015/01/17/10/49/ravioli-602087_1280.jpg"),
  Product(name: "Pasta",price: 10.3,rating: 4.7,vendor: "Kala Mama",wishList: true,image: "photo/2018/07/18/19/12/spaghetti-3547078_1280.jpg"),
          ...
          itemBuilder:(_, index){
            return Padding(
              ...
              child: GestureDetector(
                onTap: (){
                  changeScreen(_,Details(product: prouductsList[index],));
                },
                child: Container(//wraping container in gesture detector to open details
                  height: 240,
                  width: 200,
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(//wrap with container
                                padding: const EdgeInsets.all(4.0),
                                child: prouductsList[index].wishList ?
                                Icon(Icons.favorite,color: red,size: 18,):
                                Icon(Icons.favorite_border,color: red,size: 18,),//add pading
                              ),
                            ),
                          ),
                        ],
                          ...
                          Row(
                            children: <Widget>[
                              Padding(
                                ...
                                child: CustomText(text: prouductsList[index].rating.toString(),
                                  color: grey,
                                  size: 14,
                                ),
                              ),

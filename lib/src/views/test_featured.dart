...
List<TestProduct> testProuductsList = [
  ...
  TestProduct(
      ...
      vendor: "Kala Mama",
      wishList: true,
      image: "photo/2017/12/04/15/49/salmon-2997240_1280.jpg"),
  TestProduct(
      name: "Ravoli",
      price: 5.9,
      rating: 4.5,
...
class TestFeatured extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
          ...
          itemCount: testProuductsList.length,
          itemBuilder: (_, index) {
            return Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  changeScreen(
                      _,
                      TestDetails(
                        testProduct: testProuductsList[index],
                      ));
                },
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      Image.network(
                        ...
                        "https://cdn.pixabay.com/${testProuductsList[index].image}",
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child:
                                CustomText(text: testProuductsList[index].name),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: testProuductsList[index].wishList
                                    ? Icon(
                                        Icons.favorite,
                                        color: red,
                                        size: 18,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: CustomText(
                              text: "\$${testProuductsList[index].price}",
